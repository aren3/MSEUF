...
required="required"/>
<br />
<input name="psw1" type="password" value="" id="pass-teacher" class="img-responsive" placeholder="Password" required="required"/>
<br />
<!--<a id="button-link" href="admin-master.php"> <div class="col-md-12" style="margin-top:30px;">-->
<input name="register" type="button" value="Register" id="button-signin" onclick="window.location='sign.php'" />
<!--<input name="login" type="submit" value="Login"/>-->
<button name="login" type="submit" value="login" id="button-signin" />Log In</button>
</center>
</form>
</div>

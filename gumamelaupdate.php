...
<h2>Grade 7 Section GUMAMELA Student Information Page Editor</h2>
...
mysql_query("UPDATE grade7secgumamela SET studnum='$studnum', name='$name', gender='$gender' WHERE id='$id'")
or die(mysql_error());
...
$id = $_GET['id'];
$result = mysql_query("SELECT * FROM grade7secgumamela WHERE id=$id")
or die(mysql_error());

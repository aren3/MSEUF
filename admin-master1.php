...
<div class="col-md-12" id="nav-content"><ul id="content-menu">
     <li><a href="admin-master1.php"><div class="col-md-2" id="button-div">MASTER LIST</div></a></li>
      <li><a href="admin-managesec-7.php"><div class="col-md-2" id="button-div">Grades</div></a></li>
...
$sql="INSERT INTO grade7secrosal(id, studnum, name, gender)
...
echo '<td><a href="rosalupdate.php?id=' . $row['id'] . '"><center>Update Student Info</center></a></font></td>';
...
echo "<td>" . $row['name'] . "</td>";
echo "<td>" . $row['gender'] . "</td>";
echo '<td><a href="gumamelaupdate.php?id=' . $row['id'] . '">Update Student Info</a></font></td>';
...
echo "<td>" . $row['name'] . "</td>";
echo "<td>" . $row['gender'] . "</td>";
echo '<td><a href="makahiyaupdate.php?id=' . $row['id'] . '">Update Student Info</a></font></td>';

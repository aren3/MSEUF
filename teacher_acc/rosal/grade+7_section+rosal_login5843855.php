...
{
	header("Location: grade+7_section+rosal_login5843855_home.php");
}
?>
...
if ($result->num_rows > 0) {
	if($_SESSION["username"]=$username && $_SESSION["teacher"]=$username){
    header("Location:grade+7_section+rosal_login5843855_home.php");
	}
    else if($_SESSION["username"]=$username && $_SESSION["adobo"]=$username){
    header("Location:teacher-home1.php");
    }}
 else {
    echo "0 results";
}

...
<form method="post" action="principalconfirm.php" name="form1" onsubmit="return pakicheckmuna()"><h4>
<div class="reg">
...
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input type="button" value="Cancel" onclick="window.location='principal.php'">&emsp;<input type="submit" value="Submit"></h4>
</form>
</div>
</body>
</html>